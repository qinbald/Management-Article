...
export default function Login() {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-neutral p-8 border-4 border-primary shadow-[8px_8px_0px_#2E2E2E] relative">
      <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-secondary text-primary font-bold px-4 py-1 border-2 border-primary uppercase text-sm transform -rotate-2">
        AKSES TERBATAS
      </div>
      <h1 className="text-3xl font-extrabold uppercase text-primary mb-6 text-center mt-4">MASUK</h1>
      ...
      <p className="text-center text-sm font-bold uppercase text-primary mt-6">
        BELUM PUNYA AKUN? <Link href="/register" className="text-tertiary hover:underline">DAFTAR DI SINI</Link>
      </p>
    </div>
  );
}
